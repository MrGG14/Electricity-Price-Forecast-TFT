...
def get_best_lr(
    train, train_dataloader, val_dataloader, max_lr=10.0, min_lr=1e-6, **kwargs
):
...
def run_hyperparameter_optimization(
    ...
    **kwargs,
):  # el path debe tener extensión .pth
    ...
    if train_model:
        ...
        trainer = pl.Trainer(
            ...
            **kwargs.get(
                "trainer_kwargs", {}
            ),  # Agregar argumentos de entrenador opcionales
        )
        ...
        grid_tft = TemporalFusionTransformer.from_dataset(
            ...
            hidden_continuous_size=best_hyperparameters[
...
def save_exp_results(
    exp_path, tft_params, model_days, n_prev_hours, group, val_loss, epochs
):
